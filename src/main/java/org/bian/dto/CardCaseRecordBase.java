 ...
 * CardCaseRecordBase
 */
public class CardCaseRecordBase   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Unit processing the commentary 
